...
leemons.plugins.dataset.services.dataset.addLocation({
  name,
  description,
  locationName,
  pluginName,
...
leemons.plugins.dataset.services.dataset.updateLocation({
  name,
  description,
  locationName,
  pluginName,
...
leemons.plugins.dataset.services.dataset.deleteLocation(locationName, pluginName);
...
leemons.plugins.dataset.services.dataset.existLocation(locationName, pluginName);
...
leemons.plugins.dataset.services.dataset.getLocation(locationName, pluginName, { locale });
...
leemons.plugins.dataset.services.dataset.getLocation(locationName, pluginName);
...
leemons.plugins.dataset.services.dataset.addSchema({
...
leemons.plugins.dataset.services.dataset.updateSchema({
  jsonSchema, // Los mencionados en [explicacion schema]
  jsonUI, // Los mencionados en [explicacion schema]
  locationName,
  pluginName,
...
leemons.plugins.dataset.services.dataset.deleteSchema(locationName, pluginName);
...
leemons.plugins.dataset.services.dataset.existSchema(locationName, pluginName);
...
leemons.plugins.dataset.services.dataset.getSchema(locationName, pluginName);
...
leemons.plugins.dataset.services.dataset.getSchemaWithLocale(locationName, pluginName, locale);
...
leemons.plugins.dataset.services.dataset.addSchemaLocale({
  locationName,
  pluginName,
  schemaData,
  uiData,
...
leemons.plugins.dataset.services.dataset.deleteSchemaLocale({ locationName, pluginName, locale });
...
leemons.plugins.dataset.services.dataset.existSchemaLocale(locationName, pluginName, locale);
...
leemons.plugins.dataset.services.dataset.getSchemaLocale(locationName, pluginName, locale);
...
```js
leemons.plugins.dataset.services.dataset.transformJsonSchema(jsonSchema);
...
```js
leemons.plugins.dataset.services.dataset.transformUiSchema(jsonSchema);
...
leemons.plugins.dataset.services.dataset.addValues(
  locationName,
  pluginName,
  formData,
  { target } // Opcional
...
leemons.plugins.dataset.services.dataset.updateValues(
  locationName,
  pluginName,
  formData,
  { target } // Opcional
...
leemons.plugins.dataset.services.dataset.deleteValues(
  locationName,
  pluginName,
  { target } // Opcional
);
...
leemons.plugins.dataset.services.dataset.existValues(
  locationName,
  pluginName,
  { target } // Opcional
);
...
leemons.plugins.dataset.services.dataset.getValues(locationName, pluginName, {
  target, // Opcional
  keys, // Opcional
});

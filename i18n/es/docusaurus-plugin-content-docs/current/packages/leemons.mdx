...
- Escucha los cambios en el Frontend e inicia el servicio de Front.
...
El servicio de Frontend se encarga en primera instancia de recolectar todos los archivos necesarios para cargar la web, además instala las dependencias necesarias y compila la versión final.
...
<details>
<summary>Mostrar el modelo por defecto</summary>
...
<details>
<summary>Ver guía de estandarización</summary>
...
Extender el Frontend es el proceso más sencillo, pues funciona como una app de React a pequeña escala en la carpeta del Front (por defecto `/frontend/`).

:::danger TODO
Hay que documentar los `<Public>` y `<Private>` para las rutas del frontend
:::

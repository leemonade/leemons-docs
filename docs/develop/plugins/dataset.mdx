...
It is passed a schema from [react-jsonschema-form](https://rjsf-team.github.io/react-jsonschema-form) and returns two objects, one the schema to be compiled with [squirrelly.js](https://squirrelly.js.org/) and another with the texts to be stored as translations.

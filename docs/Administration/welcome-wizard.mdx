...
This functionality is not yet available, review the [bulk template installation](../getting-started/installation#5-bulk-data-creation-template-configuration) option.
:::

...
"Academic Rules" allows you to create customized rules for programs and courses: maximum or minimum core/elective credits, required subjects, elective courses... to extract grade reports and define which students will be promoted.

[https://youtu.be/VuOgdOKOHd8](https://youtu.be/VuOgdOKOHd8)

## Welcome

In this first section you could review some help tips about the best way to create an Academic Rules
...
Allows you to specify the different evaluation systems that apply to each program.
